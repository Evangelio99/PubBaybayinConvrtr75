...
class Spacer(Canvas):
    def __init__(self, parent, text, *args, **kwargs):
        ...
        self.frame_color = "#e3e6e6" #sidebar frame color
        self.hover_border_color = "black"
        ...
        self.text = Label(self, text=text, bg=self.frame_color, font="Segoe 10 bold", fg="black")
...
class SideBarButton(Canvas):
    def __init__(self, parent, text, command, icon=None, tab=True, *args, **kwargs):
        ...
        self.frame_color = "#e3e6e6" 
        self.hover_color = "#1cbdbd" #blue
        self.hover_border_color = "#3edede" #blue
        self.is_tab = tab
        ...
        self.text = Label(self, text=text, font="Segoe 10", bg=self.frame_color, fg="Black")
